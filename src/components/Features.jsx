  ...
  return (
    <div id="features" className="bg-white">
      <div className="bg-zinc-100 pt-12">
        ...
        <div className="flex flex-wrap justify-evenly gap-11 p-11">
          {featuresData.map((feature, index) => (
            <div
              key={index}
              className=" xl:w-1/4 md:w-1/4 sm:w-full  px-4 mb-8"
            >
              <FeatureCard
                image={feature.image}
                title={feature.title}
        ...
        <div className="flex justify-center items-center pb-10">
          <button className="bg-black font-semibold  text-xl text-white rounded-xl  px-10 py-5 ">
            Get Started
          </button>
        </div>
      </div>
        ...
        <div className="flex-col justify center items-center mt-12">
          ...
          <div className=" flex justify-evenly gap-11 items-center mt-8 mb-12">
            ...
            <div className=" py-12  w-96 h-44 justify-center border-slate-300 border-2 rounded-xl">
              ...
              ></motion.span>
              <span>
                <FontAwesomeIcon icon={faPlus} style={{ color: "#4fc553" }} />
              </span>
              <div className="text-center pt-4 font-thin text-3xl ">
                REPORT THEMES
              </div>
